...
public class AsyncMethodTests : MiyamasuTestRunner
{
    ...
    */
    ...
    [MTest]
    public IEnumerator AsyncMethodWithRelayout()
    {
        var box = AsyncBoxElement.GO(
            null,// bg画像
            () =>
            ...
            () =>
            {
                LayouTaro.RelayoutWithUpdateAsync<BasicMissingSpriteCache>(
                    ...
                    new Dictionary<LTElementType, object> {
                        {LTElementType.AsyncText, "hannin is yasu! this is public problem! gooooooooooooood"}
                    },
                    layouter,
                    () =>
                    {
    ...
    [MTest]
    public IEnumerator AsyncMethodComplexPatternWithRelayout()
    {
        ...
        var box = AsyncBoxElement.GO(
            ...
            AsyncImageElement.GO(null),// 画像
            AsyncButtonElement.GO(null, () => { Debug.Log("ボタンがタップされた"); }),
            AsyncTextElement2.GO("hannin is yasu! this is public problem! gooooooooooooood"),// テキスト
            AsyncImageElement.GO(null)// 画像
                                      // TextElement.GO("hannidjkfajfaoooood2")
        );
        ...
        LayouTaro.LayoutAsync<BasicMissingSpriteCache>(
            ...
            () =>
            {
                LayouTaro.RelayoutWithUpdateAsync<BasicMissingSpriteCache>(
                    ...
                    box,
                    new Dictionary<LTElementType, object> {
                        {LTElementType.AsyncText,"hannidjkfajfaoooood" },
                        {LTElementType.AsyncText2, "hannin is yasu! this is public problem! gooooooooooooood"}
                    },
                    layouter,
                    () =>
                    {
    ...
    [MTest]
    public IEnumerator AsyncMethodComplexPattern2WithRelayout()
    {
        ...
        var box = AsyncBoxElement.GO(
            ...
            AsyncImageElement.GO(null),// 画像
            AsyncImageElement.GO(null),// 画像
            AsyncTextElement3.GO("hannidjkfajfaoooood2")
        );
            ...
            () =>
            {
                LayouTaro.RelayoutWithUpdateAsync<BasicMissingSpriteCache>(
                    ...
                    new Dictionary<LTElementType, object> {
                        {LTElementType.AsyncText, "hannidjkfajfaoooood"},
                        {LTElementType.AsyncText2, "hannin is yasu! this is public problem! gooooooooooooood"},
                        {LTElementType.AsyncText3, "hannidjkfajfaoooood2"}
                    },
                    layouter,
                    () =>
                    {
    ...
    */
    [MTest]
    public IEnumerator AsyncMethodSimpleEmojiWithRelayout()
    {
        ...
        LayouTaro.LayoutAsync<BasicMissingSpriteCache>(
            ...
            () =>
            {
                LayouTaro.RelayoutWithUpdateAsync<BasicMissingSpriteCache>(
                    ...
                    box,
                    new Dictionary<LTElementType, object> {
                        {LTElementType.AsyncText, "a\U0001F60A"}
                    },
                    layouter,
                    () =>
                    {
    ...
    public IEnumerator AsyncMethodWithEmojiComplexWithRelayout()
    {
        ...
        var box = AsyncBoxElement.GO(
            ...
            AsyncImageElement.GO(null),// 画像
            AsyncButtonElement.GO(null, () => { Debug.Log("ボタンがタップされた"); }),
            AsyncTextElement2.GO("hannin is yasu!\U0001F60A\U0001F60B this is public problem! goooooooooooooad")// 59から絵文字を1文字削ると？2文字減る。文字数カウント的にはUTF8と同じ扱いなのか。うーん
        ...
        LayouTaro.LayoutAsync<BasicMissingSpriteCache>(
            ...
            () =>
            {
                LayouTaro.RelayoutWithUpdateAsync<BasicMissingSpriteCache>(
                    ...
                    new Dictionary<LTElementType, object> {
                        {LTElementType.AsyncText, "hannidjkfajfaoooood"},
                        {LTElementType.AsyncText2, "hannin is yasu!\U0001F60A\U0001F60B this is public problem! goooooooooooooad"}
                    },
                    layouter,
                    () =>
                    {
    ...
    [MTest]
    public IEnumerator AsyncMethodWithEmojiComplex2WithRelayout()
    {
        ...
        var box = AsyncBoxElement.GO(
            ...
            AsyncImageElement.GO(null),// 画像
            AsyncButtonElement.GO(null, () => { Debug.Log("ボタンがタップされた"); }),
            AsyncTextElement2.GO("hannin is yasu!\U0001F60A this is public problem! goooooooooooooad"),// テキスト
            AsyncImageElement.GO(null),// 画像
            AsyncImageElement.GO(null),// 画像
            AsyncTextElement3.GO("hannidjkfajfaoooood2")
        );
        ...
        LayouTaro.LayoutAsync<BasicMissingSpriteCache>(
            ...
            () =>
            {
                LayouTaro.RelayoutWithUpdateAsync<BasicMissingSpriteCache>(
                    ...
                    new Dictionary<LTElementType, object> {
                        {LTElementType.AsyncText, "hannidjkfajfaoooood"},
                        {LTElementType.AsyncText2, "hannin is yasu!\U0001F60A this is public problem! goooooooooooooad"},
                        {LTElementType.AsyncText3, "hannidjkfajfaoooood2"},
                    },
                    layouter,
                    () =>
    ...
    [MTest]
    public IEnumerator AsyncMethodDetectMissingEmojiWithRelayout()
    {
        // generate your own data structure with parameters for UI.
        var box = AsyncBoxElement.GO(
            null,// UI bg with image
        ...
        LayouTaro.LayoutAsync<BasicMissingSpriteCache>(
            ...
            () =>
            {
                LayouTaro.RelayoutWithUpdateAsync<BasicMissingSpriteCache>(
                    ...
                    box,
                    new Dictionary<LTElementType, object> {
                        {LTElementType.AsyncText, "\U0001F971\U0001F60A"}
                    },
                    layouter,
                    () =>
                    {
    ...
    [MTest]
    public IEnumerator AsyncMethodMarkWithRelayout()
    {
        // generate your own data structure with parameters for UI.
        var box = AsyncBoxElement.GO(
            null,// UI bg with image
